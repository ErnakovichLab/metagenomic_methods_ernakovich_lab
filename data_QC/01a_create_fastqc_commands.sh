...
COMMAND_DIR=$PROJ_DIR/00_cleaned_data/00_fastqc_commands # location to place the command files
IN_DIR=/mnt/lz01/ernakovich/btc1042/AO-MetaG/reads # location of raw fastq files
OUT_DIR=$STAGE_DIR/00_qual_check # location of output quality assessment files
CORES=4 # number of cores for fastqc to use
